...
public class ConstructionManagerWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public ConstructionManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, ConstructionManagerOrganization organization, Enterprise enterprise) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.organization = organization;
        this.enterprise = enterprise;
        this.userAccount = account;
        congestionSolutionConstructionDirectory=enterprise.getCongestionSolutionConstructionDirectory();
...
//                row[2]=route.getDistance();
    ...
    private void initComponents() {
        ...
        btnConstruct.setIcon(new javax.swing.ImageIcon("C:\\Users\\Swarup\\Documents\\NetBeansProjects\\Working Project\\report-edit-icon.png")); // NOI18N
